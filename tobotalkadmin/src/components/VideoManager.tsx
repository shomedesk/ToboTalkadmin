...
export function VideoManager({ type, title }: VideoManagerProps) {
  ...
  const handleUpload = async (file: File) => {
    ...
    try {
      ...
      formData.append("endpoint", config.r2_endpoint || import.meta.env.VITE_R2_ENDPOINT);
      formData.append("accessKeyId", config.r2_access_key_id || import.meta.env.VITE_R2_ACCESS_KEY_ID);
      formData.append("secretAccessKey", config.r2_secret_access_key || import.meta.env.VITE_R2_SECRET_ACCESS_KEY);
      formData.append("bucket", config.r2_bucket || import.meta.env.VITE_R2_BUCKET);
      formData.append("directory", config.r2_directory || import.meta.env.VITE_R2_DIRECTORY);
      formData.append("r2_public_url", config.r2_public_url || import.meta.env.VITE_R2_PUBLIC_URL || "");
